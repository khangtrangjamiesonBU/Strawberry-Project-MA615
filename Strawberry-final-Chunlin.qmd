...
```{r, warning=FALSE, message=FALSE}
pyr_0708 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/UPHOPM_E_2007-2008.xpt")
write.csv(pyr_0708, file = "pyrethrin0708.csv")
pyr_0910 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/UPHOPM_F_2009-2010.xpt")
write.csv(pyr_0910, file = "pyrethrin0910.csv")
pyr_1112 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/UPHOPM_G_2011-2012.xpt")
write.csv(pyr_1112, file = "pyrethrin1112.csv")
lung_0708 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/SPX_E_2007-2008.xpt")
write.csv(lung_0708, file = "lung0708.csv")
lung_0910 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/SPX_F_2009-2010.xpt")
write.csv(lung_0910, file = "lung0910.csv")
lung_1112 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/SPX_G_2011-2012.xpt")
write.csv(lung_1112, file = "lung1112.csv")
demo_0708 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/DEMO_E_2007-2008.xpt")
write.csv(demo_0708, file = "demo0708.csv")
demo_0910 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/DEMO_F_2009-2010.xpt")
write.csv(demo_0910, file = "demo0910.csv")
demo_1112 <- read.xport("/Users/liuchunlin/Downloads/Strawberry-project/DEMO_G_2011-2012.xpt")
...
In this project, we analyzed multiple datasets on strawberry production, pesticide usage, and health outcomes to explore potential relationships between insecticide exposure and pulmonary function.

In conclusion, we can notice that pyrethrin is indeed has disadvantages on pulmonary function measures among children aged 6–17 years, especially for boys in the age range from 11 to 17. This is the same finding that the paper did. Thus, it is fair for us to draw a conclusion that environmental exposures to pyrethrin may adversely affect pulmonary function in children.

Given the widespread usage of pyrethrin worldwide, future studies with prospective designs are warranted. Including adult populations would also be a valuable direction for future research.
